...
| `scripts/save-learning.ts <title> <url> <id> <transcript> [cc]` | Save to psi/memory/learnings/ |
...
Or manually create a learning file at `psi/memory/learnings/YYYY-MM-DD_video-slug.md`.
