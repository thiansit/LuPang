...
name: dig
description: v1.6.0 G-SKLL | Mine Claude Code sessions — timeline, gaps, repo attribution. Use when user says "dig", "sessions", "past sessions", "timeline", "what did I work on".
---
...
09:37–12:51   194m   LuPang   /recap → supergateway → CF ZT → oracle-v2 dig
                  · · ·   45m gap
12:51–13:03    12m   LuPang   Dig All + Design oracle-v2 ← current
                  · · ·   no session yet
