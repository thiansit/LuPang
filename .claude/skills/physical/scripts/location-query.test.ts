...
"Boss Device","iPhone 12 mini",75,Charging,13.6,100.7,8,unknown,,,Bang Phli,"Address 1",2026-01-18 23:59:25
...
describe("Physical Skill Logic", () => {
  test("parseCSVLine handles quotes correctly", () => {
    const line = '"Boss Device","iPhone 12 mini",75';
    const parsed = parseCSVLine(line);
    expect(parsed[0]).toBe("Boss Device"); // Quotes stripped
