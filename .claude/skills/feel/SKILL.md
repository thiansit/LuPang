...
name: feel
description: v1.6.0 G-SKLL | Log emotions with optional structure. Use when user says "feel", "feeling", "mood", "tired", "sleepy", "frustrated", "happy", "excited".
---
...
Read `psi/memory/logs/feelings/` and show summary:
...
Write to `psi/memory/logs/feels.log` (append):
...
---
Logged to psi/memory/logs/feels.log
```
